...
class CompensationProgressKind(StrEnum):
    ...
    START_COMPENSATION_VERIFICATION = "START_COMPENSATION_VERIFICATION"
    CLAIM_COMPENSATION_RETRY_ATTEMPT = "CLAIM_COMPENSATION_RETRY_ATTEMPT"
    RETRY_COMPENSATION_AFTER_VERIFICATION = "RETRY_COMPENSATION_AFTER_VERIFICATION"
